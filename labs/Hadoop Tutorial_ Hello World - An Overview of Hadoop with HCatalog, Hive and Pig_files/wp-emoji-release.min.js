...
<html>
	<head>
		...
		<script type="text/javascript">archive_analytics.values.server_name="wwwb-app11.us.archive.org";archive_analytics.values.server_ms=214;</script>
...
<!-- __ _ _ _ __| |_ (_)__ _____ 
  ...
  <head>
    ...
    <script src="//archive.org/includes/analytics.js?v=ae2df49" type="text/javascript"></script>
    <script src="//archive.org/includes/bootstrap.min.js" type="text/javascript"></script>
    <script src="/includes/archive.js?v=ae2df49" type="text/javascript"></script>
    <link href="//archive.org/includes/archive.min.css?v=ae2df49" rel="stylesheet" type="text/css"/>
        ...
        <div class="row toprow web" style="max-width:1000px;margin:auto;">
          <div class="col-xs-12">
            <div class="wayback-txt">
              Search the history of over 427 billion              pages on the Internet.
            </div>
...
<!-- /HEADER -->
        ...
        <div id="positionHome">
            ...
            <section>
            <div id="searchHome" style="margin-bottom: 50px">
                <form name="form1" method="get" action="/web/form-submit.jsp">
		    <input type="text" name="url" value="http://hortonworks.com/wp-includes/js/wp-emoji-release.min.js?ver=4.2.2" size="40" onfocus="javascript:this.focus();this.select();" >
            ...
            <div id="livewebInfo">
                ...
                <p><b><a href="/save/http://hortonworks.com/wp-includes/js/wp-emoji-release.min.js?ver=4.2.2">Save this url in the Wayback Machine</a></b></p>
            </div>

			    <p>Want to search for all archived pages under <a href="/web/form-submit.jsp?type=prefixquery&amp;url=http://hortonworks.com/wp-includes/js/">http://hortonworks.com/wp-includes/js/</a> ?</p>
